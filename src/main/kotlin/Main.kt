...
fun main() {
    ...
    println("-- show UserName- показывает все телефоны и email введённого userName.")
    println("-- find phone/email- показывает всех людей, у которых записан введённый телефон или email.")
    ...
    println("-- export path - экспортировать данные по указаному адресу")
